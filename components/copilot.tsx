    ...
    <div className="grid gap-4 animate-float-in lg:grid-cols-12 lg:gap-5">
      <Card className="command-surface premium-glow flex min-h-[560px] flex-col items-center justify-center p-5 text-center sm:p-8 lg:col-span-9 lg:min-h-[700px]">
        ...
        <h2 className="mt-3 max-w-2xl text-3xl font-semibold leading-tight text-white sm:text-5xl">
          Sua inteligência de bordo está sendo calibrada.
        </h2>
        <p className="mt-4 max-w-xl text-sm leading-6 text-slate-300">
          A interface está pronta. As respostas só serão liberadas quando o motor de IA estiver conectado com segurança.
        </p>
      ...
      <div className="grid content-start gap-4 lg:col-span-3">
        <Card className="p-5">
          ...
          <p className="mt-4 text-sm leading-6 text-muted">
            Nenhuma resposta é simulada. O chat permanece bloqueado até a integração real das IAs.
          </p>
        </Card>
        ...
        <Card className="p-5">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-xl font-semibold text-white">Próxima etapa</h3>
          </div>
          <p className="mt-4 text-sm leading-6 text-muted">
            Conectar contexto do aluno, histórico de redações e recomendações verificáveis.
          </p>
        </Card>
      </div>
    </div>
