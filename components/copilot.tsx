...
export function Copilot() {
  return (
    <div className="grid gap-4 animate-float-in lg:grid-cols-12 lg:gap-5">
      <Card className="command-surface flex min-h-[520px] flex-col items-center justify-center p-6 text-center lg:col-span-8 lg:min-h-[680px]">
        <div className="ai-orb" aria-hidden="true">
          <div className="ai-orb-core" />
        </div>
        <p className="mt-8 text-xs font-medium uppercase tracking-[0.22em] text-sky-200">Copiloto IA</p>
        <h2 className="mt-3 max-w-2xl text-3xl font-light leading-tight text-white sm:text-5xl">
        ...
        <div className="mt-8 w-full max-w-2xl rounded-lg border border-white/10 bg-black/25 p-2 text-left">
          <div className="flex items-center gap-3 rounded-lg border border-sky-300/25 bg-white/[0.045] px-3 py-3 text-sm text-slate-400">
      ...
      <div className="grid gap-4 lg:col-span-4">
        <Card className="p-5">
          <div className="flex items-center justify-between gap-3">
            <div>
              <p className="text-xs font-medium uppercase tracking-[0.20em] text-slate-500">estado do módulo</p>
              <h3 className="mt-2 text-2xl font-light text-white">Em preparação</h3>
            </div>
        ...
        <Card className="p-5">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-xl font-light text-white">O que ele fará</h3>
          </div>
